-- Database Schema for LockIn App Coin Tracking System
-- This file contains the SQL commands to create the required tables in Supabase
...
-- Policy: Users can only access their own focus sessions
...
-- Policy: Users can only access their own coin transactions
