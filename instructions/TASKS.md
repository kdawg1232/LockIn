...
1.11 Set up global tailwind styling baseline


1.13 Placehold “Opponent of the Day” card component (static data for now)


1.16 Link a basic Profile screen via header avatar tap


1.17 Test on Android & iOS simulators


1.18 Write unit tests for both frontend and backend in their respective folders.
